...
visual-json is a visual JSON editor. It provides tree view, form view, diff view,
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>@visual-json/react</code></td><td>React UI components — TreeView, FormView, DiffView, PropertyEditor, and more</td></tr>
  </tbody>
</table>
